document.getElementById('userType').addEventListener('change', function() {
    ...
    let pacienteFields = document.getElementById('pacienteFields');
...
document.getElementById('registroForm').addEventListener('submit', async function(event) {
    ...
    if (userType === 'ong') {
        ...
        password = document.getElementById('passwordPaciente').value;
    }
    ...
    if (userType === 'ong') {
        ...
        newUser.nomePaciente = document.getElementById('nomePaciente').value;
        newUser.cpf = document.getElementById('cpfPaciente').value;
    }
